                      ...
                      <div className="min-w-min flex items-center">
                        ...
                        {showLocal.withoutEa_localCoordinates && (
                          <>
                            ...
                            <TwoDimensionalArray
                              arr={value.localCoordinates_withoutEa}
                              name="L - L - sin EA"
                        ...
                        {showLocal.local_localCoordinates && (
                          <>
                            ...
                            <TwoDimensionalArray
                              arr={value.localCoordinates_complete}
                              name="L - L - con EA"
                    ...
                    <div className="overflow-x-auto relative">
                      <div className="min-w-min flex flex-col gap-4">
                        ...
                        {showLocal.transformTransposed && (
                          ...
                          =
                          \\begin{bmatrix}
                          C_\\alpha & C_\\beta & C_\\theta & 0 & 0 & 0\\\\
                          0 & 0 & 0 & C_\\alpha & C_\\beta & C_\\theta\\\\
                          \\end{bmatrix}
                          =
                          `}
                              />
                        ...
                        {showLocal.local_globalCoordinates && (
                          <>
                            ...
                            <TwoDimensionalArrayForLocalsInGlobal
                              arr={value.globalCoordinates_complete}
                              name="L - L - con EA"
