...
const TwoDimensionalArrayForLocalsInGlobal = ({
  arr,
  name,
  caption,
  tableOfDof,
      ...
      <Table className="w-auto table-auto overflow-hidden">
        ...
        <TableHeader>
          ...
          <TableRow>
            ...
            <TableHead className="font-bold text-base bg-muted-foreground/10 text-center text-muted-foreground/90" />
          ...
          <TableRow>
            <TableHead className="font-bold text-base bg-muted-foreground/10 text-center text-muted-foreground/90" />
            <TableHead className="text-center">GDL</TableHead>
            {tableOfDof.map((dof, index) => (
              <TableHead
                key={index}
                // className="font-bold text-base bg-muted-foreground/10 text-center text-muted-foreground/90"
                className={cn('text-center italic font-bold', {
                  'text-red-500': index < tableOfDof.length / 2,
                  'text-blue-500': index >= tableOfDof.length / 2,
                })}
              >
                {dof + 1}
              </TableHead>
...
export default TwoDimensionalArrayForLocalsInGlobal
