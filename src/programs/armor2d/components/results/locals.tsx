...
import TwoDimensionalArray from './shared/twoDimensionalArrayForLocals'
import TwoDimensionalArrayForLocalsInGlobal from './shared/twoDimensionalArrayForLocalsInGlobal'
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="withoutEa_localCoordinates">
              Matriz local de rigidez en coordenadas locales sin el factor EA.
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <Switch
            ...
            <Label htmlFor="local_localCoordinates">
              Matriz local de rigidez en coordenadas locales con el factor EA.
            </Label>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="withoutEa_globalCoordinates">
              Matriz local de rigidez en coordenadas globales sin el factor EA.
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <Switch
        ...
        {Array.from(locals).map(([key, value], index) => (
          <div key={index} className="flex flex-col gap-4">
            ...
            {(showLocal.transform || showLocal.transformTransposed) && (
              <div className="flex flex-col gap-4">
                <p>
                  Matrices de transformación para pasar de coordenadas locales a
                  globales:
                </p>
                <div className="overflow-x-auto relative">
                  <div className="min-w-min flex items-center">
